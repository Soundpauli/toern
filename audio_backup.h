...
AudioSynthWaveform       waveform11_2;   //xy=405.1428527832031,1310.2857389450073
AudioSynthWaveform       waveform11_1;   //xy=405.5714340209961,1269.4285259246826
AudioSynthWaveform       waveform13_2;   //xy=408,1626
AudioSynthWaveform       waveform13_1;   //xy=409.8571472167969,1582.2856178283691
AudioEffectEnvelope      envelope11;     //xy=412.9999771118164,1351.5714416503906
AudioSynthWaveform       waveform14_1;   //xy=421.28570556640625,1766.4286108016968
...
AudioMixer4              mixer_waveform11; //xy=636.7143020629883,1304.1428527832031
...
AudioEffectEnvelope      envelope13;     //xy=1073.571376800537,1610.571418762207
...
AudioEffectFreeverb      freeverb11;     //xy=1922.1428413391113,1384.285743713379
...
AudioMixer4              mixersynth_end; //xy=2889.2855682373047,1562.142858505249
...
AudioEffectEnvelope      envelope0;      //xy=3524.714366912842,426.571439743042
AudioPlaySdWav           playSdWav1;     //xy=3524.5714111328125,474.7142915725708
AudioInputI2S            audioInput;     //xy=3556.428440093994,1189.2857990264893
AudioMixer4              mixerPlay;      //xy=3714,1048
AudioMixer4              mixer0;         //xy=3722,478
AudioAnalyzePeak         peak1;          //xy=3727.1425857543945,541.6666765213013
AudioRecordQueue         queue1;         //xy=3778.4285411834717,1164.4285640716553
AudioAnalyzePeak         peakRec;          //xy=3788.571123123169,1215.2380828857422
AudioMixer4              mixer_stereoL;  //xy=3931,848
AudioMixer4              mixer_stereoR;  //xy=3932,748
AudioOutputI2S           i2s1;           //xy=4154.714282989502,795.7142643928528
AudioConnection          patchCord1(SNchaosMix, 0, SNtone, 0);
AudioConnection          patchCord2(SNchaosMix, 0, SNtone2, 0);
AudioConnection          patchCord3(HHchaosMix, 0, HHtone, 0);
AudioConnection          patchCord4(HHchaosMix, 0, HHtone2, 0);
...
AudioConnection          patchCord7(SNtone2, 0, SNchaosMix, 0);
AudioConnection          patchCord8(SNtone2, 0, SNtoneMix, 1);
AudioConnection          patchCord9(HHtone2, 0, HHchaosMix, 0);
AudioConnection          patchCord10(HHtone2, 0, HHtoneMix, 1);
AudioConnection          patchCord11(HHtone, 0, HHtoneMix, 0);
AudioConnection          patchCord12(BDpitchEnv, 0, BDchaosMix, 0);
AudioConnection          patchCord13(waveform11_2, 0, mixer_waveform11, 1);
AudioConnection          patchCord14(waveform11_1, 0, mixer_waveform11, 0);
AudioConnection          patchCord15(waveform13_2, 0, mixer_waveform13, 1);
AudioConnection          patchCord16(waveform13_1, 0, mixer_waveform13, 0);
AudioConnection          patchCord17(envelope11, 0, mixer_waveform11, 2);
...
AudioConnection          patchCord20(SNtoneMix, SNtoneEnv);
AudioConnection          patchCord21(HHtoneMix, HHtoneEnv);
AudioConnection          patchCord22(BDchaosMix, 0, BDsine, 0);
AudioConnection          patchCord23(BDchaosMix, 0, BDsaw, 0);
AudioConnection          patchCord24(BDchaosMix, 0, BDsaw, 1);
AudioConnection          patchCord25(mixer_waveform11, bitcrusher11);
AudioConnection          patchCord26(mixer_waveform13, envelope13);
AudioConnection          patchCord27(SNtoneEnv, 0, SNMix, 1);
AudioConnection          patchCord28(mixer_waveform14, envelope14);
AudioConnection          patchCord29(SNnoise, 0, SNMix, 0);
AudioConnection          patchCord30(HHtoneEnv, 0, HHMix, 1);
AudioConnection          patchCord31(HHnoise, 0, HHMix, 0);
AudioConnection          patchCord32(BDsine, 0, BDMix, 0);
AudioConnection          patchCord33(BDsaw, 0, BDMix, 1);
AudioConnection          patchCord34(BDsaw, 0, BDchaosMix, 1);
AudioConnection          patchCord35(SNMix, SNenv);
AudioConnection          patchCord36(HHMix, HHenv);
AudioConnection          patchCord37(BDMix, BDenv);
AudioConnection          patchCord38(SNenv, 0, SNfilt, 0);
AudioConnection          patchCord39(HHenv, 0, HHfilt, 0);
AudioConnection          patchCord40(envelope13, bitcrusher13);
AudioConnection          patchCord41(BDenv, 0, BDfilter, 0);
AudioConnection          patchCord42(envelope14, bitcrusher14);
AudioConnection          patchCord43(SNfilt, 1, SnFilter, 0);
AudioConnection          patchCord44(HhFilter, 0, HhFilterMix, 0);
AudioConnection          patchCord45(HhFilter, 2, HhFilterMix, 1);
AudioConnection          patchCord46(BDfilter, 0, BdFilterMix, 0);
AudioConnection          patchCord47(BDfilter, 2, BdFilterMix, 1);
AudioConnection          patchCord48(HHfilt, 1, HhFilter, 0);
AudioConnection          patchCord49(bitcrusher11, amp11);
AudioConnection          patchCord50(bitcrusher13, amp13);
AudioConnection          patchCord51(SnFilter, 0, SnFilterMix, 0);
AudioConnection          patchCord52(SnFilter, 2, SnFilterMix, 1);
AudioConnection          patchCord53(bitcrusher14, amp14);
AudioConnection          patchCord54(HhFilterMix, 0, HHMixer, 1);
AudioConnection          patchCord55(amp13, 0, filter13, 0);
AudioConnection          patchCord56(amp11, 0, filter11, 0);
AudioConnection          patchCord57(BdFilterMix, 0, BDMixer, 1);
AudioConnection          patchCord58(SnFilterMix, 0, SNMixer, 1);
AudioConnection          patchCord59(amp14, 0, filter14, 0);
AudioConnection          patchCord60(filter13, 0, filtermixer13, 0);
AudioConnection          patchCord61(filter13, 1, filtermixer13, 1);
AudioConnection          patchCord62(filter13, 2, filtermixer13, 2);
AudioConnection          patchCord63(filter11, 0, filtermixer11, 0);
AudioConnection          patchCord64(filter11, 1, filtermixer11, 1);
AudioConnection          patchCord65(filter11, 2, filtermixer11, 2);
AudioConnection          patchCord66(filter14, 0, filtermixer14, 0);
AudioConnection          patchCord67(filter14, 1, filtermixer14, 1);
AudioConnection          patchCord68(filter14, 2, filtermixer14, 2);
AudioConnection          patchCord69(BDMixer, envelope1);
AudioConnection          patchCord70(SNMixer, envelope2);
AudioConnection          patchCord71(HHMixer, envelope3);
AudioConnection          patchCord72(filtermixer13, freeverb13);
AudioConnection          patchCord73(filtermixer13, 0, synthmixer13, 3);
AudioConnection          patchCord74(filtermixer13, 0, synthmixer13, 0);
AudioConnection          patchCord75(filtermixer14, freeverb14);
AudioConnection          patchCord76(filtermixer14, 0, synthmixer14, 3);
AudioConnection          patchCord77(filtermixer14, 0, synthmixer14, 0);
AudioConnection          patchCord78(filtermixer11, freeverb11);
AudioConnection          patchCord79(filtermixer11, 0, synthmixer11, 3);
AudioConnection          patchCord80(filtermixer11, 0, synthmixer11, 0);
AudioConnection          patchCord81(freeverb13, 0, synthmixer13, 1);
AudioConnection          patchCord82(freeverb14, 0, synthmixer14, 1);
AudioConnection          patchCord83(envelope8, bitcrusher8);
AudioConnection          patchCord84(envelope6, bitcrusher6);
AudioConnection          patchCord85(freeverb11, 0, synthmixer11, 1);
AudioConnection          patchCord86(envelope7, bitcrusher7);
AudioConnection          patchCord87(envelope3, bitcrusher3);
AudioConnection          patchCord88(envelope1, bitcrusher1);
AudioConnection          patchCord89(envelope5, bitcrusher5);
AudioConnection          patchCord90(envelope4, bitcrusher4);
AudioConnection          patchCord91(envelope2, bitcrusher2);
AudioConnection          patchCord92(bitcrusher6, amp6);
AudioConnection          patchCord93(bitcrusher7, amp7);
AudioConnection          patchCord94(bitcrusher8, amp8);
AudioConnection          patchCord95(bitcrusher4, amp4);
AudioConnection          patchCord96(bitcrusher5, amp5);
AudioConnection          patchCord97(bitcrusher1, amp1);
AudioConnection          patchCord98(bitcrusher2, amp2);
AudioConnection          patchCord99(bitcrusher3, amp3);
AudioConnection          patchCord100(synthmixer14, 0, mixersynth_end, 3);
AudioConnection          patchCord101(synthmixer11, 0, mixersynth_end, 0);
AudioConnection          patchCord102(synthmixer13, 0, mixersynth_end, 2);
AudioConnection          patchCord103(amp8, 0, filter8, 0);
AudioConnection          patchCord104(amp7, 0, filter7, 0);
AudioConnection          patchCord105(amp6, 0, filter6, 0);
AudioConnection          patchCord106(amp4, 0, filter4, 0);
AudioConnection          patchCord107(amp5, 0, filter5, 0);
AudioConnection          patchCord108(amp3, 0, filter3, 0);
AudioConnection          patchCord109(amp2, 0, filter2, 0);
AudioConnection          patchCord110(amp1, 0, filter1, 0);
AudioConnection          patchCord111(filter1, 0, filtermixer1, 0);
AudioConnection          patchCord112(filter1, 1, filtermixer1, 1);
AudioConnection          patchCord113(filter1, 2, filtermixer1, 2);
AudioConnection          patchCord114(filter8, 0, filtermixer8, 0);
AudioConnection          patchCord115(filter8, 1, filtermixer8, 1);
AudioConnection          patchCord116(filter8, 2, filtermixer8, 2);
AudioConnection          patchCord117(filter6, 0, filtermixer6, 0);
AudioConnection          patchCord118(filter6, 1, filtermixer6, 1);
AudioConnection          patchCord119(filter6, 2, filtermixer6, 2);
AudioConnection          patchCord120(filter7, 0, filtermixer7, 0);
AudioConnection          patchCord121(filter7, 1, filtermixer7, 1);
AudioConnection          patchCord122(filter7, 2, filtermixer7, 2);
AudioConnection          patchCord123(filter4, 0, filtermixer4, 0);
AudioConnection          patchCord124(filter4, 1, filtermixer4, 1);
AudioConnection          patchCord125(filter4, 2, filtermixer4, 2);
AudioConnection          patchCord126(filter2, 0, filtermixer2, 0);
AudioConnection          patchCord127(filter2, 1, filtermixer2, 1);
AudioConnection          patchCord128(filter2, 2, filtermixer2, 2);
AudioConnection          patchCord129(filter3, 0, filtermixer3, 0);
AudioConnection          patchCord130(filter3, 1, filtermixer3, 1);
AudioConnection          patchCord131(filter3, 2, filtermixer3, 2);
AudioConnection          patchCord132(filter5, 0, filtermixer5, 0);
AudioConnection          patchCord133(filter5, 1, filtermixer5, 1);
AudioConnection          patchCord134(filter5, 2, filtermixer5, 2);
AudioConnection          patchCord135(filtermixer7, freeverb7);
AudioConnection          patchCord136(filtermixer7, 0, freeverbmixer7, 3);
AudioConnection          patchCord137(filtermixer1, freeverb1);
AudioConnection          patchCord138(filtermixer1, 0, freeverbmixer1, 3);
AudioConnection          patchCord139(filtermixer8, freeverb8);
AudioConnection          patchCord140(filtermixer8, 0, freeverbmixer8, 3);
AudioConnection          patchCord141(filtermixer4, 0, mixer1, 3);
AudioConnection          patchCord142(filtermixer6, 0, mixer2, 1);
AudioConnection          patchCord143(filtermixer5, 0, mixer2, 0);
AudioConnection          patchCord144(filtermixer2, freeverb2);
AudioConnection          patchCord145(filtermixer2, 0, freeverbmixer2, 3);
AudioConnection          patchCord146(filtermixer3, 0, mixer1, 2);
AudioConnection          patchCord147(freeverb1, 0, freeverbmixer1, 0);
AudioConnection          patchCord148(freeverb7, 0, freeverbmixer7, 0);
AudioConnection          patchCord149(freeverb2, 0, freeverbmixer2, 0);
AudioConnection          patchCord150(freeverb8, 0, freeverbmixer8, 0);
AudioConnection          patchCord151(mixersynth_end, 0, mixer_end, 2);
AudioConnection          patchCord152(freeverbmixer1, 0, mixer1, 0);
AudioConnection          patchCord153(freeverbmixer7, 0, mixer2, 2);
AudioConnection          patchCord154(freeverbmixer8, 0, mixer2, 3);
AudioConnection          patchCord155(freeverbmixer2, 0, mixer1, 1);
AudioConnection          patchCord156(mixer1, 0, mixer_end, 0);
AudioConnection          patchCord157(mixer2, 0, mixer_end, 1);
AudioConnection          patchCord158(mixer_end, 0, mixerPlay, 0);
AudioConnection          patchCord159(mixer_end, 0, mixerPlay, 1);
AudioConnection          patchCord160(envelope0, 0, mixer0, 0);
AudioConnection          patchCord161(playSdWav1, 0, mixer0, 1);
AudioConnection          patchCord162(playSdWav1, 0, peak1, 0);
AudioConnection          patchCord163(audioInput, 0, queue1, 0);
AudioConnection          patchCord164(audioInput, 0, peakRec, 0);
AudioConnection          patchCord165(mixerPlay, 0, mixer_stereoL, 0);
AudioConnection          patchCord166(mixerPlay, 0, mixer_stereoR, 0);
AudioConnection          patchCord167(mixer0, 0, mixer_stereoL, 1);
AudioConnection          patchCord168(mixer0, 0, mixer_stereoR, 1);
AudioConnection          patchCord169(mixer_stereoL, 0, i2s1, 1);
AudioConnection          patchCord170(mixer_stereoR, 0, i2s1, 0);
AudioControlSGTL5000     sgtl5000_1;     //xy=3827.1428985595703,1361.5714554786682
// GUItool: end automatically generated code
