...
(library Library_1
	...
	(compDef "BQ24075TRGTR" (originalName "BQ24075TRGTR") (compHeader (numPins 17) (numParts 1) (refDesPrefix IC)
		...
		(compPin "15" (pinName "SYSOFF") (partNum 1) (symPinNum 15) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://componentsearchengine.com/Datasheets/1/BQ24075TRGTR.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "BQ24075TRGTR.stp")
