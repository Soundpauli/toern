...
EXTMEM AudioMixer4                     filtermixer11;  //xy=1750,1309
EXTMEM AudioMixer4                     filtermixer13;  //xy=1736,1622
EXTMEM AudioMixer4                     filtermixer14;  //xy=1746,1796
...
AudioEffectFreeverbDMAMEM             freeverb11;     //xy=1922,1384
...
EXTMEM AudioMixer4                     synthmixer11;   //xy=2120,1326
EXTMEM AudioMixer4                     synthmixer13;   //xy=2119,1623
EXTMEM AudioMixer4                     synthmixer14;   //xy=2114,1802
...
EXTMEM AudioMixer4                     filtermixer1;   //xy=2604,528
EXTMEM AudioMixer4                     filtermixer2;   //xy=2611,639
EXTMEM AudioMixer4                     filtermixer3;   //xy=2611,730
EXTMEM AudioMixer4                     filtermixer4;   //xy=2608,807
EXTMEM AudioMixer4                     filtermixer5;   //xy=2609,883
EXTMEM AudioMixer4                     filtermixer6;   //xy=2608,958
EXTMEM AudioMixer4                     filtermixer7;   //xy=2601,1034
EXTMEM AudioMixer4                     filtermixer8;   //xy=2603,1111
AudioEffectFreeverbDMAMEM             freeverb1;      //xy=2750,488
AudioEffectFreeverbDMAMEM             freeverb2;      //xy=2761,627
AudioEffectFreeverbDMAMEM             freeverb5;      //xy=2759,998
AudioEffectFreeverbDMAMEM             freeverb6;      //xy=2765,108
AudioEffectFreeverbDMAMEM             freeverb7;      //xy=2759,998
AudioEffectFreeverbDMAMEM             freeverb8;      //xy=2765,1083
EXTMEM AudioMixer4                     mixersynth_end; //xy=2889,1562
EXTMEM AudioMixer4                     freeverbmixer1; //xy=2964,513
EXTMEM AudioMixer4                     freeverbmixer2; //xy=2978,657
EXTMEM AudioMixer4                     freeverbmixer5; //xy=2970,912
EXTMEM AudioMixer4                     freeverbmixer6; //xy=2970,1004
EXTMEM AudioMixer4                     freeverbmixer7; //xy=2970,1016
EXTMEM AudioMixer4                     freeverbmixer8; //xy=2970,1108
EXTMEM AudioMixer4                     mixer1;         //xy=3200,763
EXTMEM AudioMixer4                     mixer2;         //xy=3200,948
AudioEffectEnvelope             envelope0;      //xy=3524,426
AudioPlaySdWav                  playSdWav1;     //xy=3524,474
EXTMEM AudioMixer4                     mixer_end;      //xy=3518,1059
...
EXTMEM AudioConnection        patchCord16(waveform13_1, 0, mixer_waveform13, 0);
EXTMEM AudioConnection        patchCord17(waveform13_2, 0, mixer_waveform13, 1);
EXTMEM AudioConnection        patchCord18(waveform14_1, 0, mixer_waveform14, 0);
EXTMEM AudioConnection        patchCord19(waveform14_2, 0, mixer_waveform14, 1);
EXTMEM AudioConnection        patchCord20(Swaveform2_2, 0, Smixer1_2, 1);
EXTMEM AudioConnection        patchCord21(Swaveform2_2, 0, Smixer2_2, 1);
EXTMEM AudioConnection        patchCord22(Swaveform3_0, 0, Smixer1_0, 2);
EXTMEM AudioConnection        patchCord23(Swaveform3_0, 0, Smixer2_0, 2);
EXTMEM AudioConnection        patchCord24(Swaveform3_1, 0, Smixer1_1, 2);
EXTMEM AudioConnection        patchCord25(Swaveform3_1, 0, Smixer2_1, 2);
EXTMEM AudioConnection        patchCord26(Swaveform3_2, 0, Smixer1_2, 2);
EXTMEM AudioConnection        patchCord27(Swaveform3_2, 0, Smixer2_2, 2);
...
EXTMEM AudioConnection        patchCord39(Swaveform1_1, 0, Smixer2_1, 0);
EXTMEM AudioConnection        patchCord40(Swaveform1_2, 0, Smixer1_2, 0);
EXTMEM AudioConnection        patchCord41(Swaveform1_2, 0, Smixer2_2, 0);
EXTMEM AudioConnection        patchCord42(Swaveform2_0, 0, Smixer1_0, 1);
...
EXTMEM AudioConnection        patchCord88(Sladder1_0, 0, Senvelope1_0, 0);
EXTMEM AudioConnection        patchCord89(Sladder1_1, 0, Senvelope1_1, 0);
EXTMEM AudioConnection        patchCord90(Sladder1_2, 0, Senvelope1_2, 0);
...
EXTMEM AudioConnection        patchCord106(filter13, 0, filtermixer13, 0);
EXTMEM AudioConnection        patchCord107(filter13, 1, filtermixer13, 1);
EXTMEM AudioConnection        patchCord108(filter13, 2, filtermixer13, 2);
EXTMEM AudioConnection        patchCord109(filter14, 0, filtermixer14, 0);
EXTMEM AudioConnection        patchCord110(filter14, 1, filtermixer14, 1);
EXTMEM AudioConnection        patchCord111(filter14, 2, filtermixer14, 2);
EXTMEM AudioConnection        patchCord112(Senvelope1_0, 0, SmixerL4, 0);
EXTMEM AudioConnection        patchCord113(Senvelope1_1, 0, SmixerL4, 1);
EXTMEM AudioConnection        patchCord114(Senvelope1_2, 0, SmixerL4, 2);
...
EXTMEM AudioConnection        patchCord124(sound7, 0, envelope7, 0);
EXTMEM AudioConnection        patchCord125(filtermixer11, 0, freeverb11, 0);
EXTMEM AudioConnection        patchCord126(filtermixer11, 0, synthmixer11, 3);
//EXTMEM AudioConnection        patchCord128(filtermixer13, 0, freeverb13, 0);
EXTMEM AudioConnection        patchCord129(filtermixer13, 0, synthmixer13, 3);
//EXTMEM AudioConnection        patchCord131(filtermixer14, 0, freeverb14, 0);
EXTMEM AudioConnection        patchCord132(filtermixer14, 0, synthmixer14, 3);
EXTMEM AudioConnection        patchCord134(SmixerL4, 0, CHMixer11, 0);
//EXTMEM AudioConnection        patchCord135(freeverb13, 0, synthmixer13, 0);
EXTMEM AudioConnection        patchCord136(SmixerR4, 0, CHMixer11, 1);
EXTMEM AudioConnection        patchCord137(envelope1, 0, bitcrusher1, 0);
EXTMEM AudioConnection        patchCord138(envelope2, 0, bitcrusher2, 0);
EXTMEM AudioConnection        patchCord139(envelope3, 0, bitcrusher3, 0);
EXTMEM AudioConnection        patchCord140(envelope4, 0, bitcrusher4, 0);
EXTMEM AudioConnection        patchCord141(envelope5, 0, bitcrusher5, 0);
EXTMEM AudioConnection        patchCord142(envelope6, 0, bitcrusher6, 0);
EXTMEM AudioConnection        patchCord143(envelope7, 0, bitcrusher7, 0);
EXTMEM AudioConnection        patchCord144(envelope8, 0, bitcrusher8, 0);
EXTMEM AudioConnection        patchCord145(freeverb11, 0, synthmixer11, 0);
//EXTMEM AudioConnection        patchCord146(freeverb14, 0, synthmixer14, 0);
EXTMEM AudioConnection        patchCord147(CHMixer11, 0, mixer_waveform11, 3);
EXTMEM AudioConnection        patchCord148(bitcrusher4, 0, amp4, 0);
EXTMEM AudioConnection        patchCord149(bitcrusher5, 0, amp5, 0);
EXTMEM AudioConnection        patchCord150(bitcrusher6, 0, amp6, 0);
EXTMEM AudioConnection        patchCord151(bitcrusher7, 0, amp7, 0);
EXTMEM AudioConnection        patchCord152(bitcrusher8, 0, amp8, 0);
EXTMEM AudioConnection        patchCord153(bitcrusher1, 0, amp1, 0);
EXTMEM AudioConnection        patchCord154(bitcrusher2, 0, amp2, 0);
EXTMEM AudioConnection        patchCord155(bitcrusher3, 0, amp3, 0);
EXTMEM AudioConnection        patchCord156(synthmixer11, 0, mixersynth_end, 0);
EXTMEM AudioConnection        patchCord157(synthmixer13, 0, mixersynth_end, 2);
EXTMEM AudioConnection        patchCord158(synthmixer14, 0, mixersynth_end, 3);
EXTMEM AudioConnection        patchCord159(sound0, 0, envelope0, 0);
EXTMEM AudioConnection        patchCord160(amp1, 0, filter1, 0);
EXTMEM AudioConnection        patchCord161(amp2, 0, filter2, 0);
EXTMEM AudioConnection        patchCord162(amp3, 0, filter3, 0);
EXTMEM AudioConnection        patchCord163(amp4, 0, filter4, 0);
EXTMEM AudioConnection        patchCord164(amp5, 0, filter5, 0);
EXTMEM AudioConnection        patchCord165(amp6, 0, filter6, 0);
EXTMEM AudioConnection        patchCord166(amp7, 0, filter7, 0);
EXTMEM AudioConnection        patchCord167(amp8, 0, filter8, 0);
//test granular
//AudioEffectGranular      granular1;      //xy=504,155
//EXTMEM AudioConnection        patchCord167a(amp8, 0, granular1, 0);
//EXTMEM AudioConnection        patchCord167b(granular1, 0, filter8, 0);

EXTMEM AudioConnection        patchCord168(filter1, 0, filtermixer1, 0);
EXTMEM AudioConnection        patchCord169(filter1, 1, filtermixer1, 1);
EXTMEM AudioConnection        patchCord170(filter1, 2, filtermixer1, 2);
EXTMEM AudioConnection        patchCord171(filter2, 0, filtermixer2, 0);
EXTMEM AudioConnection        patchCord172(filter2, 1, filtermixer2, 1);
EXTMEM AudioConnection        patchCord173(filter2, 2, filtermixer2, 2);
EXTMEM AudioConnection        patchCord174(filter3, 0, filtermixer3, 0);
EXTMEM AudioConnection        patchCord175(filter3, 1, filtermixer3, 1);
EXTMEM AudioConnection        patchCord176(filter3, 2, filtermixer3, 2);
EXTMEM AudioConnection        patchCord177(filter4, 0, filtermixer4, 0);
EXTMEM AudioConnection        patchCord178(filter4, 1, filtermixer4, 1);
EXTMEM AudioConnection        patchCord179(filter4, 2, filtermixer4, 2);
EXTMEM AudioConnection        patchCord180(filter5, 0, filtermixer5, 0);
EXTMEM AudioConnection        patchCord181(filter5, 1, filtermixer5, 1);
EXTMEM AudioConnection        patchCord182(filter5, 2, filtermixer5, 2);
EXTMEM AudioConnection        patchCord183(filter6, 0, filtermixer6, 0);
EXTMEM AudioConnection        patchCord184(filter6, 1, filtermixer6, 1);
EXTMEM AudioConnection        patchCord185(filter6, 2, filtermixer6, 2);
EXTMEM AudioConnection        patchCord186(filter7, 0, filtermixer7, 0);
EXTMEM AudioConnection        patchCord187(filter7, 1, filtermixer7, 1);
EXTMEM AudioConnection        patchCord188(filter7, 2, filtermixer7, 2);
EXTMEM AudioConnection        patchCord189(filter8, 0, filtermixer8, 0);
EXTMEM AudioConnection        patchCord190(filter8, 1, filtermixer8, 1);
EXTMEM AudioConnection        patchCord191(filter8, 2, filtermixer8, 2);
EXTMEM AudioConnection        patchCord192(filtermixer1, 0, freeverb1, 0);
EXTMEM AudioConnection        patchCord193(filtermixer1, 0, freeverbmixer1, 3);
EXTMEM AudioConnection        patchCord194(filtermixer2, 0, freeverb2, 0);
EXTMEM AudioConnection        patchCord195(filtermixer2, 0, freeverbmixer2, 3);
EXTMEM AudioConnection        patchCord196(filtermixer3, 0, mixer1, 2);
EXTMEM AudioConnection        patchCord197(filtermixer4, 0, mixer1, 3);
EXTMEM AudioConnection        patchCord198(filtermixer5, 0, freeverb5, 0);
EXTMEM AudioConnection        patchCord198b(filtermixer5, 0, freeverbmixer5, 3);
EXTMEM AudioConnection        patchCord199(filtermixer6, 0, freeverb6, 0);
EXTMEM AudioConnection        patchCord199b(filtermixer6, 0, freeverbmixer6, 3);
EXTMEM AudioConnection        patchCord200(filtermixer7, 0, freeverb7, 0);
EXTMEM AudioConnection        patchCord201(filtermixer7, 0, freeverbmixer7, 3);
EXTMEM AudioConnection        patchCord202(filtermixer8, 0, freeverb8, 0);
EXTMEM AudioConnection        patchCord203(filtermixer8, 0, freeverbmixer8, 3);
EXTMEM AudioConnection        patchCord204(freeverb1, 0, freeverbmixer1, 0);
EXTMEM AudioConnection        patchCord205(freeverb2, 0, freeverbmixer2, 0);
EXTMEM AudioConnection        patchCord205b(freeverb5, 0, freeverbmixer5, 0);
EXTMEM AudioConnection        patchCord205c(freeverb6, 0, freeverbmixer6, 0);
EXTMEM AudioConnection        patchCord206(freeverb7, 0, freeverbmixer7, 0);
EXTMEM AudioConnection        patchCord207(freeverb8, 0, freeverbmixer8, 0);
EXTMEM AudioConnection        patchCord208(mixersynth_end, 0, mixer_end, 2);
EXTMEM AudioConnection        patchCord209(freeverbmixer1, 0, mixer1, 0);
EXTMEM AudioConnection        patchCord210(freeverbmixer2, 0, mixer1, 1);
EXTMEM AudioConnection        patchCord210b(freeverbmixer5, 0, mixer2, 0);
EXTMEM AudioConnection        patchCord210c(freeverbmixer6, 0, mixer2, 1);
EXTMEM AudioConnection        patchCord211(freeverbmixer7, 0, mixer2, 2);
EXTMEM AudioConnection        patchCord212(freeverbmixer8, 0, mixer2, 3);
EXTMEM AudioConnection        patchCord213(mixer1, 0, mixer_end, 0);
EXTMEM AudioConnection        patchCord214(mixer2, 0, mixer_end, 1);
EXTMEM AudioConnection        patchCord215(envelope0, 0, mixer0, 0);
EXTMEM AudioConnection        patchCord216(playSdWav1, 0, mixer0, 1);
